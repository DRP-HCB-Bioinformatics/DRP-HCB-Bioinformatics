...
The DRP-HCB Bioinformatics Core runs annual in-person training workshops covering a variety of topics including Linux command line, analysis of high throughput sequencing (HTS) data, programming languages and data science. Please refer to our [training](training.html) page for details of upcoming courses.

This page is intended to provide a set of additional resources for those interested in learning about bioinformatics and acquiring new skills. It is by no means a comprehensive list of online training materials and does not cover everything you need to know to become a skilled bioinformatician. However, it should be enough to get you started and we will happily add more subjects if they are of interest to our users.

Our dedicated bioinformatics servers provide an excellent training platform with an expansive list of tools via the Linux command line, an RStudio server and access to programming languages and libraries such as Python and Perl. If you require an account, please contact [Shaun Webb](mailto:shaun.webb@ed.ac.uk).
