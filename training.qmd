...
The course is divided into six modules. Participants can register for the full course or individual modules.
...
- Monthly bioinformatics clinic for further advice
...
Get to grips with sequencing data and formats. Navigate public repositories such as ENA, SRA, and GEO, to identify datasets of interest. Download, explore and assess sequencing data for further analysis.

- Search and download data from public repositories
- Understand HTS file formats
- Perform quality control and assess sequencing data
- Prepare reference sequences for your analysis
...
Tuesday 24th September, 9am - 3pm\
JCMB 1206C, Kings Buildings
